...
pub async fn start_secure_rpc_worker<C: Context>(context: &C, operator_event_rx: mpsc::Receiver<OperatorEvent<TrustedSetupFor<C>>>) -> (JoinHandle<()>, mpsc::Sender<RpcEvent<EncryptedTxFor<C>>>) {
